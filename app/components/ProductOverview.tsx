            ...
            {stats ? (
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    {stats.lowStockCount > 0 && (
                        <div className='border-2 p-4 border-warning/40 bg-warning/5 rounded-3xl col-span-2'>
                            <p className='stat-title'>Alertes stock faible</p>
                            <div className='flex justify-between items-center'>
                                <div className='stat-value text-warning'>{stats.lowStockCount}</div>
                                <div className='bg-warning/25 p-3 rounded-full'>
